...
class Pnp(Component):
    ...
    def __init__(self, name, pos):
        ...
        self.shapeImage = 'pnp.svg'

        self.addParameter('Ref',  'Q',    True, QPointF(10, 10), Color.black)
        self.addParameter('Value', 'PNP', True, QPointF(10, 60), Color.blue)

        self.addTerminal('B', 1, TERM.INOUT, QPointF(0, 30), TERM.DIR_WEST)
        self.addTerminal('C', 2, TERM.INOUT, QPointF(40, 0), TERM.DIR_NORTH)
        self.addTerminal('E', 3, TERM.INOUT, QPointF(40, 60), TERM.DIR_SOUTH)
