...
from sim import SIM_MODELICA


class Generator_MODELICA(Component):
    '''
    Generator - Modelica script
    '''
    ...
    def drawShape(self, gc):
        ...
        gc.drawText(self.box, Qt.AlignCenter, 'MOD')
