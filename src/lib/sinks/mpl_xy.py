...
Načíta dáta zo súboru vo formáte JSON a zobrazí ich.
Pre úpravu dát je použitý backend QT4Agg, umožňuje doplňujúce úpravy dát.
...
plt.plot(x_data, y_data, plot_format)
plt.show()
